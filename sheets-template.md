# Google Sheets Setup — Ground Review Website

## Step 1 — Create the sheet

1. Go to [sheets.google.com](https://sheets.google.com) and create a new spreadsheet
2. Name it: **Ground Review — RFP 26-039AS**
3. Create the following **9 tabs** (exact names, lowercase):
   `config` · `stats` · `firm` · `projects` · `team` · `workplan` · `timeline` · `metrics` · `pillars`
4. **File → Share → Share with others → Anyone with the link → Viewer**
5. Copy the Sheet ID from the URL:
   `https://docs.google.com/spreadsheets/d/`**`THIS_PART`**`/edit`
6. Paste that ID into `index.html` line ~1885:
   `const SHEET_ID = 'paste-your-id-here';`
...
> Use `\n` for line breaks in plain text fields. Use `<br>` in fields that already contain HTML.
...
## Tab: `projects`
Columns: `name` | `location` | `tag1` | `tag2` | `tag3` | `tag4` | `body` | `relevance`

| name | location | tag1 | tag2 | tag3 | tag4 | body | relevance |
|------|----------|------|------|------|------|------|-----------|
| City Center Motel | Long Beach, California | Tenant Curation | F&B | Mixed-Use | Community Destination | Paloma Communities engaged Ground Review... | Directly relevant: tenant curation... |
| Smoke & Fire / Villains Brewery | Anaheim & Long Beach, California | Multi-Location | Brewery + Distillery | Placemaking | Packing District | Ground Review secured three landmark... | Directly relevant: activating large-format... |
| Rye Goods Bakery | Newport Beach, Laguna Beach & Tustin, CA | Multi-Site Rollout | Site Selection | Design & Execution | OC Markets | Ground Review supported Rye Goods'... | Relevant to GR's ability to manage... |

---

## Tab: `team`
Columns: `initials` | `name` | `title` | `bio` | `cred1` | `cred2` | `cred3` | `cred4` | `cred5` | `participation_label` | `participation_pct` | `role_tag`

| initials | name | title | bio | cred1 | cred2 | cred3 | cred4 | cred5 | participation_label | participation_pct | role_tag |
|----------|------|-------|-----|-------|-------|-------|-------|-------|---------------------|-------------------|----------|
| RC | Roman Ciuni | Finance + Real Estate · Principal | Roman leads real estate... | B.A. Music Performance, University of Southern California | Director of Real Estate & Finance, LAB Holding LLC (2015–) | Former broker: CBRE, Marcus & Millichap, NAI Capital | Specialist in experiential retail & mixed-use development | Irvine, CA (30 min from Corona) | Participation Level — Primary (Oversight, Strategy, City Liaison) | 90 | Primary · Project Lead |
| JH | Jason House | Leasing + Retail Strategy | Jason leads leasing... | Finance & Social Business, Wharton School, U. of Pennsylvania | Direct leasing lead: LAB Anti-Mall, The Camp, Anaheim Packing District | Founder, Project Potential (community enterprise, India) | Specializes in social-cultural placemaking + tenant fit | Laguna Beach, CA | Participation Level — Primary (Vendor Curation, Programming, Markets) | 85 | Primary · Leasing + Curation |

---

## Tab: `workplan`
Columns: `num` | `title` | `subtitle` | `duration` | `description` | `d1_title` | `d1_desc` | `d2_title` | `d2_desc` | `d3_title` | `d3_desc` | `d4_title` | `d4_desc`

| num | title | subtitle | duration | description | d1_title | d1_desc | d2_title | d2_desc | d3_title | d3_desc | d4_title | d4_desc |
|-----|-------|----------|----------|-------------|----------|---------|----------|---------|----------|---------|----------|---------|
| 01 | Discovery & Immersion | Weeks 1–4 · Roman Ciuni (lead) + Full Team | Weeks 1–4 | Before programming, we listen... | Community Audit | Demographic & cultural landscape assessment | Tenant Interviews | One-on-one sessions with all Hub. tenants | Site Assessment | Backyard capacity mapping, flow analysis | Competitive Review | Regional event programming analysis |
| 02 | Programming Architecture | Weeks 3–8 · Jason House (lead) + Roman Ciuni | Weeks 3–8 | Drawing from discovery findings... | Annual Calendar | 52-week programming plan | Weekly Activations | Live music, DJ nights, trivia, fitness | Monthly Markets | Artisan, vintage, makers, cultural celebrations | Signature Events | Concert series, holiday festivals, art walks |
| 03 | Vendor & Sponsor Activation | Weeks 6–12 · Jason House (lead) | Weeks 6–12 | Ground Review's vendor network... | Vendor Roster | Curated food truck, pop-up, and artisan vendor network | Sponsorship Packages | Title, presenting, and supporting sponsor tiers | Farmers Market | Vendor recruitment, agricultural coordination | Revenue Model | Ticketing, vendor fees, and sponsorship revenue tracking |
| 04 | Launch & Ongoing Operations | Month 3 → Contract Duration · Full Team | Month 3 → Ongoing | Execution with consistency... | Operations Management | Permit coordination, compliance, staffing | Marketing Execution | Social media management, digital + print collateral | Attendance Tracking | Foot traffic metrics, social engagement reporting | City Communication | Monthly reporting, open-book financials |
| 05 | Reporting & Continuous Improvement | Quarterly · Roman Ciuni (lead) | Quarterly, Ongoing | Ground Review believes in full transparency... | Quarterly Reports | Attendance, revenue, sponsorship, social growth | Budget Reconciliation | Detailed cost/revenue accounting | Annual Reset | Full programming calendar review + next-year planning | Performance Metrics | Aligned to City's Vendor Performance Evaluation Form |

---

## Tab: `timeline`
Columns: `milestone` | `deliverable` | `lead`
